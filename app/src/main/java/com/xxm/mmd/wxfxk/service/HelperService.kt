    ...
    override fun onAccessibilityEvent(event: AccessibilityEvent) {
        ...
        when (eventType) {
            AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED -> {
                if (HelperData.get(Constant.RED_PACKET, false)) {
                    when (className) {
                ...
                if (HelperData.get(Constant.ADD_FRIENDS, false) && HelperData.get(Constant.GROUP_NAME, "") != "") {
                    when (className) {
                ...
                if (HelperData.get(Constant.FRIEND_SQUARE,false)) {
...
//            }
    ...
    private fun searchGroup() {
        ...
        if (nodeInfo != null) {
            ...
            for (info in nodes) {
                if (info.text.toString() == HelperData.get(Constant.GROUP_NAME)) {
