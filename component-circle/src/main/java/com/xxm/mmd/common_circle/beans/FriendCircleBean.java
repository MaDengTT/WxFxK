package com.xxm.mmd.common_circle.beans;
...
public class FriendCircleBean {
    ...
    public void setContentSpan(SpannableStringBuilder contentSpan, Context context) {
        this.contentSpan = contentSpan;
        this.isShowCheckAll = Utils.calculateShowCheckAllText(contentSpan.toString(),context);
    }

    private SpannableStringBuilder contentSpan;


    public void setContent(String content,Context context) {
        this.content = content;
        setContentSpan(new SpannableStringBuilder(content),context);
    }
