...
import com.xxm.mmd.common_circle.SimpleWeakObjectPool;
import com.xxm.mmd.common_circle.TimerUtils;
...
import com.xxm.mmd.common_circle.beans.CommentBean;
...
public class VerticalCommentWidget extends LinearLayout implements ViewGroup.OnHierarchyChangeListener,
    ...
    private void init() {
        mCommentVerticalSpace = Utils.dp2px(3f,getContext());
    ...
    private void addOnItemClickPopupMenuListener(View view, final int index, final TranslationState translationState) {
        view.setOnLongClickListener(
                new OnLongClickListener() {
                    @Override
                    public boolean onLongClick(View view) {
                        Utils.showPopupMenu(getContext(), VerticalCommentWidget.this, index, view, translationState);
                        return false;
                    }
                });
    }
