...
import com.xxm.mmd.common_circle.beans.OtherInfoBean;
import com.xxm.mmd.common_circle.beans.PraiseBean;
import com.xxm.mmd.common_circle.beans.UserBean;
...
public class DataCenter {
    ...
    public static List<FriendCircleBean> makeFriendCircleBeans(Context context) {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            friendCircleBean.setContent(Constants.CONTENT[(int) (Math.random() * 10)],context);
